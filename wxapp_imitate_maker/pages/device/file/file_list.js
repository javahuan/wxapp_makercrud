Page({
    ...
    getFileRecord: function () {
        let that = this;
        wx.request({
            url: 'http://localhost:8080/wxcruduse_war_exploded/device_file_servlet_action?action=get_device_record',
            data: {},
            header: {
            ...
            success: function (res) {
                that.handleGetFileRecordResult(res);
            },
            fail: function (res) {
    ...
    handleGetFileRecordResult: function (res) {
        ...
        wx.showModal({
            ...
            complete: (res) => {
                if (res.confirm) {
                    ...
                    let that = this;
                    wx.request({
                        url: 'http://localhost:8080/wxcruduse_war_exploded/device_file_servlet_action?action=delete_device_record',
                        data: {
                            "id": id
                        },
                        header: {
                        ...
                        success: function (res) {
                            console.log("成功删除");
                            // that.handledeleteFileRecordResult(res);
                            that.getFileRecord();
                        },
                        fail: function (res) {}
    ...
    onModifyRecord: function (e) {
        ...
        var type =e. currentTarget.dataset.itemtype;
